...
export const GENSHIN_CHARACTERS: CharacterData[] = [
  { 
    ...
    element: "水", 
    defaults: {
      weights: { "会心率": 1, "会心ダメージ": 1, "HP%": 1, "元素熟知": 0.3 },
  ...
  { 
    ...
    element: "水", 
    defaults: {
      weights: { "会心率": 1, "会心ダメージ": 1, "HP%": 1, "元素チャージ効率": 0.8 },
  ...
  { 
    ...
    element: "草", 
    defaults: {
      weights: { "会心率": 0.8, "会心ダメージ": 0.8, "元素熟知": 1, "攻撃力%": 0.2 },
  ...
  { 
    ...
    element: "雷", 
    defaults: {
      weights: { "会心率": 1, "会心ダメージ": 1, "元素チャージ効率": 1, "攻撃力%": 0.8 },
